				...
				<div class="panel-body form-horizontal">
					...
					<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"/> <!-- 403 forbidden 에러 안나도록 -->
						...
						<div class="form-group btnAdd" id="btnAdd">
						    <label class="col-sm-2 control-label" style="white-space: nowrap;">변경할 참여자 수</label>
							<div class="col-sm-10 ">
						...
						<div class="form-group partiContainer">
							<label class="col-sm-2 control-label" style="white-space: nowrap;">참여자 닉네임</label>
						</div>
...
<%-- 수정된 정보를 post방식으로 modify 컨트롤러로 넘기기 --%>
	$("#btnModify").on("click", function(){
		...
		var nickname = '<c:out value="${dutchboard.dutchboard.nickname}"/>';
...
<%-- <<<<<< 첨부파일 관련 코드 >>>>>> --%>
<script>
var pno = '<c:out value="${dutchboard.dutchboard.pno}"/>' ;
